...
<div class="container">
    <div class="row">
        <div class="col-sm-6 col-md-5 ">
            <div>
                <h3 style="color:#ffffff">Visa Applications</h1>
                <p class="lead">
...
<table id="myTable" class="display table" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="{{ asset('home/visa-applications/'.$users->id)}}" onclick="javascript:return confirm('Are you sure you want to delete ?')" 
                     data-toggle="tooltip" title="Delete">
                     <i style="float:right; padding-right: 10px;" class=" icon-Trash-withMen"></i>
                     <a href="{{ asset('home/visa-applications-details/'.$users->id)}}" 
